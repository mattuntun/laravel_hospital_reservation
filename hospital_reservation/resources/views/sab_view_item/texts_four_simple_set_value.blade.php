    ...
    <table>
        ...
        <tr>
            <td>
                ...
                <input class="form-control" type="text" name={{$input_name3}} value="{{$defaultValue3}}">
            </td>
            <td>
                <label class="control-label">{{$label_value4}}</label>
                <input class="form-control" type="text" name={{$input_name4}} value="{{$defaultValue4}}">
            </td>
        </tr>
    </table>
</div>
...
{{--     @include('sab_view_item.texts_four_tagged',
                  ['label_value1'=>'姓(漢字)',
                   ...
                   'defaultValue1'=>'デフォルトの値',
                   'defaultValue2'=>'デフォルトの値',
                   'defaultValue3'=>'デフォルトの値',
                   'defaultValue4'=>'デフォルトの値']) --}}