...
{{-- このコンポーネントはformとしての囲い(メソッドはpost) --}}
        @component('component_item.form')
                 @slot('form_action')
                 /common_reservation_setting_screen/date_specification_horiday_setting_all_department
                 @endslot
    ...
    @endforeach
        ...
        @foreach($get_holiday_datas as $get_holiday_data)
            <tr>
                ...
                <td>
                    <form action="/common_reservation_setting_screen/date_specification_horiday_setting_all_department" method="post">
